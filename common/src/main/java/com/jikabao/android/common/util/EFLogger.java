...
/**
 * EFLogger presents both the old static logging API and new instance methods that mirror the
 * slf4j.logger interface. Both API's forward logging requests to slf4j.
 *
 * Note that with the static methods there is only one logger, with the name EFLogger.
 */
